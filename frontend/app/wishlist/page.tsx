...
export default function WishlistPage() {
  ...
  const { removeFromWishlist: removeFromWishlistContext, refetchWishlist } =
    useWishlist();
...
useEffect(() => {
  ...
  if (user.role !== "user") {
    setLoading(false);
    setError("Wishlist is only available for users.");
    return;
  }
              ...
              {error ? (
                ...
                <>
                  ...
                  <p className="text-muted-foreground mb-8">
                    Start adding books you love to your wishlist. They&apos;ll
                    be saved here for later!
                  </p>
          ...
          <div className="mt-16 text-center">
            ...
            <Link href="/bestsellers">
              <Button
                size="lg"
                variant="outline"
                className="border-gold/30 hover:bg-gold hover:text-primary-foreground"
              >
                Browse Best Sellers
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
