...
const mainCategories = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1592496431122-2349e0fbc666?w=600&h=400&fit=crop",
    subcategories: [
      "Motivation",
      "Mindfulness",
      "Relationships",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary via-primary to-primary/90 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            Explore our extensive collection organized by genre. Find your
            perfect read from over 15,000 titles across 20+ categories.
          </p>
        </div>
      </section>
            ...
            <div className="relative p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-center md:text-left">
                ...
                <p className="text-primary-foreground/80 max-w-xl mb-6">
                  Dive into thought-provoking narratives that explore the human
                  condition. Our curated selection features award-winning
                  authors and timeless classics.
                </p>
                <Link
