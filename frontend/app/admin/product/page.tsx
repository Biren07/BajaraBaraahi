...
export default function AdminProductPage() {
  ...
  const exportToExcel = () => {
    ...
    saveAs(file, "books_inventory.xlsx");
  };
      ...
      <div className="space-y-6 pb-20 md:pb-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-2 md:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <Button
              onClick={openAdd}
              className="bg-[#800000] hover:bg-[#600000] text-white rounded-2xl h-12 px-6 shadow-lg w-full sm:w-auto"
            >
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-gray-50/50">
                  <TableRow>
                    <TableHead className="pl-8 h-14 text-[11px] font-bold uppercase text-gray-400">
                      Book Listing
                    </TableHead>
                    <TableHead className="text-[11px] font-bold uppercase text-gray-400">
                      Category/Genre
                    </TableHead>
                    <TableHead className="text-[11px] font-bold uppercase text-gray-400">
                      Price
                    </TableHead>
                    <TableHead className="text-[11px] font-bold uppercase text-gray-400 text-center">
                      Stock
                    </TableHead>
                    <TableHead className="text-right pr-8 text-[11px] font-bold uppercase text-gray-400">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
                      ...
                      >
                        <TableCell className="pl-8 py-5">
                          <div className="flex items-center gap-4">
                            <img
                              src={p.cover_Img?.url}
                              className="w-12 h-16 object-cover rounded-xl border"
                              alt=""
                            />
                        ...
                        <TableCell>
                          <div className="flex flex-col gap-1">
                            <span className="text-[10px] font-black uppercase text-[#800000] bg-[#800000]/5 px-2 py-0.5 rounded-md w-fit">
                              {p.category}
                            </span>
          ...
          <div className="grid grid-cols-1 gap-4 md:hidden px-2">
            {loading ? (
              ...
              currentProducts.map((p) => (
                <div
                  key={p._id}
                  className="bg-white p-4 rounded-[24px] shadow-sm border border-gray-100 flex flex-col gap-4"
                >
                  <div className="flex gap-4">
                    <div className="relative">
                      <img
                        src={p.cover_Img?.url}
                        className="w-20 h-28 min-w-[80px] object-cover rounded-2xl shadow-sm border"
                        alt=""
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        <span className="text-[9px] font-black uppercase text-[#800000] bg-[#800000]/5 px-2 py-0.5 rounded-md">
                          {p.category}
                        </span>
                      ...
                      <h3 className="font-bold text-gray-900 mt-1.5 truncate leading-tight">
                        {p.title}
                      </h3>
            ...
            <div className="relative w-full max-w-5xl bg-[#FDFCFB] sm:rounded-[40px] shadow-2xl overflow-hidden h-full sm:h-auto max-h-screen sm:max-h-[95vh] flex flex-col">
              ...
              <div className="px-6 md:px-10 py-5 md:py-6 border-b border-gray-100 flex items-center justify-between bg-white shrink-0">
                ...
                <button
                  ...
                  className="p-2 md:p-3 hover:bg-gray-100 rounded-2xl text-gray-400 transition-colors"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
                  ...
                  <div className="lg:col-span-8 space-y-6 md:space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                      ...
                      <div className="md:col-span-2 space-y-1.5">
                        ...
                        <Input
                          className="rounded-2xl h-12 md:h-14 text-base font-medium shadow-sm"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Textarea
                        className="rounded-[24px] min-h-[140px] md:min-h-[160px] resize-none p-4 text-sm leading-relaxed shadow-sm"
              ...
              <div className="p-6 md:p-10 border-t border-gray-100 bg-white flex flex-col md:flex-row gap-3 shrink-0">
                <Button
                  variant="ghost"
                  className="order-2 md:order-1 flex-1 h-12 md:h-14 rounded-2xl font-bold text-gray-500 hover:bg-gray-50"
                  onClick={() => setOpen(false)}
                >
                  Discard Changes
                </Button>
                <Button
                  className="order-1 md:order-2 flex-[2] h-12 md:h-14 rounded-2xl bg-[#800000] hover:bg-[#600000] text-white font-black shadow-lg transition-all active:scale-[0.98]"
                  onClick={submit}
                  disabled={submitting}
                >
                  {submitting ? (
