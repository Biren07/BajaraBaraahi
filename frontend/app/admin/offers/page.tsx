  ...
  const handleOpenDialog = (offer?: any) => {
    if (offer) {
      ...
      setFormData({
        ...
        bookIds: offer.books?.map((b: any) => b._id || b) || [],
          ...
          <div className="space-y-4">
                ...
                <CardContent className="p-0">
                  <Table>
                    <TableHeader className="bg-gray-50/50">
                      <TableRow>
                        <TableHead className="pl-8 h-16 font-bold uppercase text-[10px] text-gray-400 tracking-widest">
                          Offer Name
                        </TableHead>
                        <TableHead className="font-bold uppercase text-[10px] text-gray-400 tracking-widest">
                          Type
                        </TableHead>
                        <TableHead className="font-bold uppercase text-[10px] text-gray-400 tracking-widest">
                          Value
                        ...
                        <TableHead className="text-right pr-8 font-bold uppercase text-[10px] text-gray-400 tracking-widest">
                          Actions
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {offers.map((offer) => (
                        ...
                        >
                          <TableCell className="pl-8 py-5 font-bold text-gray-900">
                            {offer.name}
                          </TableCell>
                          <TableCell>
                            <Badge
            ...
            <div className="grid grid-cols-1 gap-4 md:hidden">
              {offers.map((offer) => (
                <Card
                  key={offer._id}
                  className="rounded-[24px] border-none shadow-md bg-white overflow-hidden active:scale-[0.98] transition-transform"
                >
                  <CardContent className="p-5">
                    <div className="flex justify-between items-start mb-4">
                      <div className="space-y-1">
                        <Badge
                          className={`rounded-full px-2 py-0.5 text-[9px] font-black uppercase mb-1 ${
                            offer.type === "stock-clearance"
                              ? "bg-green-50 text-green-600"
                              : offer.type === "festive"
                                ? "bg-red-50 text-red-600"
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                      ...
                      <div className="flex gap-2">
                        <Button
                          onClick={() => handleOpenDialog(offer)}
                          size="icon"
                          className="w-10 h-10 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-600 shadow-none border-none"
                        >
                          <Edit className="w-4 h-4" />
                        </Button>
                        <Button
                          onClick={() => handleDelete(offer._id)}
                          size="icon"
                          className="w-10 h-10 rounded-full bg-red-50 hover:bg-red-100 text-red-600 shadow-none border-none"
                        >
                          <Trash2 className="w-4 h-4" />
                        </Button>
                      </div>
        ...
        {!loading && offers.length === 0 && (
          <div className="text-center py-20 bg-gray-50/50 rounded-[32px] border-2 border-dashed border-gray-200">
            ...
            <p className="text-sm text-gray-500">
              Launch a new campaign to boost sales
            </p>
          </div>
        )}
          ...
          <DialogContent className="w-[95%] max-w-[550px] p-0 overflow-hidden border-none rounded-[24px] md:rounded-[32px] bg-white shadow-2xl">
            <div className="px-6 md:px-8 py-5 md:py-6 border-b border-gray-50 bg-gray-50/50">
              <DialogHeader>
                ...
                <DialogDescription className="font-medium text-xs md:text-sm text-gray-500">
            ...
            <div className="p-6 md:p-8 space-y-5 md:space-y-6 max-h-[75vh] overflow-y-auto">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <SelectContent className="">
                        <SelectItem value="stock-clearance">
                          Stock Clearance
                        </SelectItem>
                      ...
                      {filteredBooks.map((book) => (
                        <div
                          ...
                          className={`flex items-center space-x-3 p-3 rounded-xl transition-all cursor-pointer ${
                            formData.bookIds.includes(book._id)
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="date"
                    className="rounded-xl h-12 border-gray-100 bg-gray-50/50 text-xs"
            ...
            <div className="p-6 md:p-8 bg-white border-t border-gray-50 flex gap-3">
              <Button
                variant="ghost"
                className="flex-1 h-12 md:h-14 rounded-xl md:rounded-2xl font-bold text-gray-500"
