    ...
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-gradient-to-br from-background via-background to-muted/50">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(6)].map((_, i) => (
          ...
          >
            <BookOpen className="w-8 h-8 md:w-12 md:h-12 text-gold" />
          </div>
        ))}
      </div>
      ...
      <div className="container mx-auto px-4 pt-32 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gold/10 text-gold px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                size="lg"
                className="bg-gold hover:bg-gold-dark text-primary-foreground px-8 py-6 text-lg font-semibold group transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gold/25"
              >
                {slide.cta}
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-border">
              ...
              <div className="text-center lg:text-left">
                <p className="text-3xl md:text-4xl font-bold text-gold">25K+</p>
            ...
            <div className="relative w-full aspect-square">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="absolute -right-8 -top-4 w-48 h-64 bg-gold/80 rounded-lg shadow-2xl transform rotate-12 animate-float" style={{ animationDelay: "1s" }} />
                  
                  {/* Main book */}
                  <div className="relative w-56 h-72 bg-gradient-to-br from-gold via-gold-light to-gold-dark rounded-lg shadow-2xl flex items-center justify-center animate-float">
              ...
              <div className="absolute bottom-20 left-10 w-16 h-16 bg-gold/20 rounded-lg rotate-45 animate-bounce-slow" />
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        ...
        <div className="w-6 h-10 border-2 border-gold/50 rounded-full flex justify-center pt-2">
          <div className="w-1.5 h-3 bg-gold rounded-full animate-scroll" />
        </div>
      </div>
